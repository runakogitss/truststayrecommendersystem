...
def load_runtime(
    ...
    aspect_tokenizer = AutoTokenizer.from_pretrained(
        ASPECT_MODEL_ID, revision=aspect_revision, use_fast=False, local_files_only=local_files_only
    )
    ...
    sentiment_tokenizer = AutoTokenizer.from_pretrained(
        SENTIMENT_MODEL_ID, revision=sentiment_revision, use_fast=False, local_files_only=local_files_only
    )
